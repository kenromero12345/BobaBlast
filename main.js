...
function generateStoreTowers(game) {
    ...
    var fifthTower = new storeTower(game, "Tower 5", 200, "Tower 5 \ncan shoot 2 bobas \nevery second.",AM.getAsset("./img/tower.png"), 1015, 270, 70,70,1,1);
    var sixthTower = new storeTower(game, "Tower 6", 100, "Tower 6 \ncan shoot 1 boba \nevery second.",AM.getAsset("./img/tower.png"), 1085, 270, 70,70,2,1);
    var seventhTower = new storeTower(game, "Tower 7", 1000, "Tower 7 \ncan shoot 15 bobas \nevery second.",AM.getAsset("./img/tower.png"), 945, 340,70,70,0,2);
    var eightTower = new storeTower(game, "Tower 8", 2000, "Tower 8 \ncan shoot 20 bobas \nevery second.",AM.getAsset("./img/tower.png"), 1015, 340,70,70,1,2);
    var ninthTower = new storeTower(game, "Tower 9", 2200, "Tower 9 \ncan shoot 21 bobas \nevery second.",AM.getAsset("./img/tower.png"), 1085, 340,70,70,2,2);
